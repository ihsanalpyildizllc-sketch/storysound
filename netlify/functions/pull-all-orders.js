// netlify/functions/pull-all-orders.js — temporary, pulls all Shopify orders with note_attributes
exports.handler = async (event) => {
  ...
  const r = await fetch(`${base}/orders.json?status=paid&limit=50&fields=id,order_number,email,total_price,customer,note_attributes,created_at`,{headers:H});
